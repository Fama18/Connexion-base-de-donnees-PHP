        ...
        <div id="container">
            ...
            <main>
                ...
                <form id="form1" method="post" action="">
                    <fieldset id="field1">
                        <legend id="legend1">Client nouveau/ancien</legend>
                        <div id="infoClient">
                            <div id="infoClient1">
                                ...
                                <select id="TypeClient" name="TypeClient" value="" onChange="location = this.options[this.selectedIndex].value;" onchange="testClient()">
                                    <option>--Sélectionner client nouveau ou ancien--</option>
                                    <option value="../View/client.php">Nouveau client</option>
                                    <option value="../View/client_ancien.php">Ancien client</option>
                                </select>
