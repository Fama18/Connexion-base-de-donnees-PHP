                ...
                <?php
                        ...
                        try {
                            ...
                            if($result->rowCount() > 0) {
                                ...
                                echo "<tr><td>".$row["numCni"]."</td><td style=\"width:100px\">".$row["nom"]."</td><td style=\"width:100px\">".$row["prenom"]."</td><td>".$row["DateDeNaissance"]."</td><td>".$row["adresse"]."</td><td>".$row["email"]."</td><td>".$row["telephone"]."</td></tr>";
                                }
                                echo "</table>";
                                echo "</div>";
                                }
